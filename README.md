...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Reprodução de Músicas com Botões</title>
</head>
<body>
    <h1>Músicas</h1>
    ...
    <script>
        ...
        btn1.addEventListener('click', function() {
            audioSource.src = 'https://www.youtube.com/watch?v=JMsP7fAcQtc';
            audioPlayer.load();
        ...
        btn2.addEventListener('click', function() {
            audioSource.src = 'https://www.youtube.com/watch?v=s7RRgF5Ve_E';
            audioPlayer.load();
            audioPlayer.style.display = 'block';
            audioPlayer.play();
        });
...
<body>
    ...
    <button id="btn1">História em Português</button>
    <button id="btn2">História em Inglês</button>

    <div id="text-container">
        <p id="text1">Esta é a história completa em português: "Era uma vez, num reino distante..."</p>
        <p id="text2" style="display: none;">This is the full story in English: "Once upon a time, in a faraway kingdom..."</p>
    </div>
    ...
    <script>
        ...
        // URLs das músicas
        const music1 = "https://www.youtube.com/watch?v=JMsP7fAcQtc";
        const music2 = "https://www.youtube.com/watch?v=s7RRgF5Ve_E";

        // Função para alternar textos
        function showText(language) {
            text1.style.display = language === 'pt' ? 'block' : 'none';
            text2.style.display = language === 'en' ? 'block' : 'none';
        }
        ...
        // Alternância automática entre as músicas
        audioPlayer.addEventListener('ended', function () {
            if (audioSource.src.includes(music1)) {
                playMusic(music2);
            } else {
                playMusic(music1);
            }
